...
/**
 * Class containing method which open appropriate xml file (which depends on
...
public class ParserHelper {
	...
	/**
	 * If build type of application is set to debug, function returns
	 * InputStream to file chosen by user. If chosen file is null or application
	 * is not set to debug function return InputStream to predefined file from
	 * resources.
	 * 
	...
	/**
	 * This function creates {@link ZooLocationsDataParser} and returns result
	 * of its work as a {@link ZooLocationsData} object. If build type of
	 * application is set to debug, parser can use file chosen by user.
	 * Otherwise it uses predefined file from resources.
	 * 
	 * @param ctx context of application
	 * @param file file chosen by user
	 * @return parsed data from xml file
	 **/
	public ZooLocationsData parse(Context ctx, File file) throws IOException,
