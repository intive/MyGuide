/*
 https://github.com/MikeWeller/MWLogging
 
 MWLogging. Simple wrapper macros/functions around ASL (Apple System Log)

 We support a compile-time log level through
 MW_COMPILE_TIME_LOG_LEVEL. This will turn the associated log calls into NOPs.
...
// By default, in non-debug mode we want to disable any logging statements except NOTICE and above.
